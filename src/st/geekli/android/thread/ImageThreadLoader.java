...
public class ImageThreadLoader {
  ...
  /**
   * Defines an interface for a callback that will handle responses from the thread loader when an image is
   * done being loaded.
   */
  ...
  /**
   * Provides a Runnable class to handle loading the image from the URL and settings the ImageView on the UI
   * thread.
   */
  ...
  /**
   * Convenience method to retrieve a bitmap image from a URL over the network. The built-in methods do not
   * seem to work, as they return a FileNotFound exception.
   * 
